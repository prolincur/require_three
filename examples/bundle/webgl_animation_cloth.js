...
define(['require_three'], function() {
  'use strict';
        ...
        const textureBase = 'https://raw.githubusercontent.com/mrdoob/three.js/master/examples/textures/'
				const clothTexture = loader.load( textureBase + '/patterns/circuit_pattern.png' );
				...
				const groundTexture = loader.load( textureBase + '/terrain/grasslight-big.jpg' );
